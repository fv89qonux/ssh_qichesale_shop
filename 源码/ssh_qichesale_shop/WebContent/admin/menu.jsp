	...
	<table width='99%' height="100%" border='0' cellspacing='0' cellpadding='0'>
	  <tr>
	    <td style='padding-left:3px;padding-top:8px' valign="top">
	      ...
	      <!-- 1 -->
	      <dl class='bitem'>
	        <dt onClick='showHide("items5_1")'><b>二手车管理</b></dt>
	        <dd style='display:block' class='sitem' id='items5_1'>
	          <ul class='sitemu'>
	             <li><a href='<%=path %>/catelogMana.action' target='main'>二手车类别管理</a> </li>
	             <li><a href='<%=path %>/goodsManaNoTejia.action' target='main'>二手车信息管理</a> </li>
	          </ul>
	        </dd>
	      </dl>
	      <!-- 1 -->
